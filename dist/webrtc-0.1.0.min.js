...
(function(window) {
    ...
    (function(WebRTC) {
        ...
        EventBus = function(options) {
            ...
            var events = [ "message", "userMediaUpdated", "reInvite", "incomingCall", "connected", "registered", "unregistered", "registrationFailed", "disconnected", "progress", "failed", "started", "held", "resumed", "ended", "calling", "newDTMF", "viewChanged", "dataSent", "dataReceived", "smsLoggedIn", "smsReadAll", "smsSent" ];
        ...
        EventBus.prototype.userMediaUpdated = function(localStream) {
            this.emit("userMediaUpdated", this, {
    ...
    (function(WebRTC) {
        var Configuration, logger = new ExSIP.Logger(WebRTC.name + " | " + "Configuration"), Flags = {
            enableHD: 1,
            enableCallControl: 2,
            enableCallTimer: 4,
            enableCallHistory: 8,
        ...
        Configuration.prototype = {
            ...
            getDTMFOptions: function() {
                return {
                    duration: WebRTC.C.DEFAULT_DURATION,
                    interToneGap: WebRTC.C.DEFAULT_INTER_TONE_GAP
                };
            },
    ...
    (function(WebRTC) {
        var Settings, logger = new ExSIP.Logger(WebRTC.name + " | " + "Settings");
        Settings = function(client, configuration, sound, eventBus, sipStack) {
            ...
            this.cookiesMapper = {
                ...
                settingResolutionDisplay: {
                    ...
                    initValue: function() {
                        return self.configuration.displayResolution || $.cookie("settingResolutionDisplay") || WebRTC.C.DEFAULT_RESOLUTION_DISPLAY;
                    },
                    inputSetter: function(val) {
                ...
                settingResolutionEncoding: {
                    ...
                    initValue: function() {
                        return self.configuration.encodingResolution || $.cookie("settingResolutionEncoding") || WebRTC.C.DEFAULT_RESOLUTION_ENCODING;
                    },
                    inputSetter: function(val) {
                ...
                settingWindowPosition: {
                    ...
                    inputSetter: function(val) {},
                    inputGetter: function() {
                        return ".localVideo" + "-" + self.localVideoTop.val() + "-" + self.localVideoLeft.val() + "|" + ".callHistory" + "-" + self.settingCallHistoryTop.val() + "-" + self.settingCallHistoryLeft.val() + "|" + ".callStats" + "-" + self.settingCallStatsTop.val() + "-" + self.settingCallStatsLeft.val();
                    }
                }
            };
    ...
    (function(WebRTC) {
        ...
        History.Call.prototype = {
            ...
            toString: function() {
                var values = [ this.startTime, this.destination, this.direction, this.resolutionIn, this.resolutionOut, this.bitrateIn, this.bitrateOut, this.frameRateIn, this.frameRateOut, this.audioLostPer, this.videoLostPer, this.jitter, this.length ];
                return values.join("|");
            }
        };
        History.prototype = {
            ...
            createCall: function(rtcSession) {
                ...
                call.length = WebRTC.Utils.format(Math.round(Math.abs((rtcSession.end_time - start) / 1e3)));
                return call;
            },
            toggle: function() {
    ...
    (function(WebRTC) {
        var Timer, logger = new ExSIP.Logger(WebRTC.name + " | " + "Timer");
        ...
        Timer.prototype = {
            start: function() {
                ...
                this.callTimer = setInterval(timer, 1e3);
            ...
            getSeconds: function() {
                return Math.round((new Date().getTime() - (this.startTime || new Date().getTime())) / 1e3);
            },
            updateText: function() {
    ...
    (function(WebRTC) {
        var FileShare, logger = new ExSIP.Logger(WebRTC.name + " | " + "FileShare"), C = {
    ...
    (function(WebRTC) {
        ...
        Stats.prototype = {
            ...
            getAvg: function(type, name) {
                return Math.round($('[data-type="' + type + '"][data-var="' + name + '"]').attr("data-avg") * 100) / 100;
            },
            initialize: function() {
                var self = this;
    ...
    (function(WebRTC) {
        ...
        Utils = {
            ...
            containsKey: function(object, value) {
                return $.inArray(value, $.map(object, function(key, value) {
                    return key;
                })) !== -1;
            },
            ...
            whiteboardCompabilityCheck: function() {
                ...
                if (!isChrome) {
                    return "Chrome is required for whiteboard feature, please go to:<br>" + "<a href='http://chrome.google.com'>http://chrome.google.com</a>";
                }
                var major = this.majorVersion();
                if (isChrome && major < 34) {
                    return "Your version of Chrome must be upgraded to at least version 34 in order to be able to use the whiteboard<br>" + "Please go to: <a href='http://chrome.google.com'>http://chrome.google.com</a> or <a href='https://www.google.com/intl/en/chrome/browser/canary.html'>https://www.google.com/intl/en/chrome/browser/canary.html</a>";
                }
            },
            compatibilityCheck: function(client) {
                ...
                if (!isChrome && !isFirefox) {
                    return "Chrome or Firefox is required, please go to:<br>" + "<a href='http://chrome.google.com'>http://chrome.google.com</a> or <a href='http:www.mozilla.org'>http://www.mozilla.org</a>";
                }
                var major = this.majorVersion();
                if (isChrome && major < 25) {
                    return "Your version of Chrome must be upgraded to at least version 25<br>" + "Please go to: <a href='http://chrome.google.com'>http://chrome.google.com</a>";
                } else {
                    if (isFirefox && major < 22) {
                        return "Your version of Firefox must be upgraded to at least version 22y<br>" + "Please go to: <a href='http://www.mozilla.org'>http://www.mozilla.org</a>";
                    }
    ...
    (function(WebRTC) {
        var Video, logger = new ExSIP.Logger(WebRTC.name + " | " + "Video");
    ...
    (function(WebRTC) {
        var SIPStack, logger = new ExSIP.Logger(WebRTC.name + " | " + "SIPStack"), C = {
        ...
        Authentication.prototype = {
            registerListeners: function() {
                ...
                this.okButton.bind("click", function() {
                    ...
                    if (!userId) {
                        self.alert.text("Invalid User ID").fadeIn(10).fadeOut(4e3);
                        return;
                    }
    ...
    (function(WebRTC) {
        var XMPP, logger = new ExSIP.Logger(WebRTC.name + " | " + "XMPP");
    ...
    (function(WebRTC) {
        var SMSProvider, logger = new ExSIP.Logger(WebRTC.name + " | " + "SMSProvider");
    ...
    (function(WebRTC) {
        var SMS, logger = new ExSIP.Logger(WebRTC.name + " | " + "SMS");
    ...
    (function(WebRTC) {
        var Client, logger = new ExSIP.Logger(WebRTC.name + " | " + "Client");
        ...
        Client.prototype = {
            ...
            guiStart: function() {
                ...
                this.client.find(".remoteVideo, .videoBar").fadeIn(1e3);
                if (this.configuration.enableCallControl) {
                    this.callControl.fadeIn(1e3);
                } else {
                    this.callControl.fadeOut(1e3);
                }
            },
            ...
            message: function(text, level) {
                ...
                messageEl.text(text).fadeIn(10).fadeOut(1e4);
            },
            ...
            registerListeners: function() {
                ...
                this.eventBus.on("registered", function(e) {
                    ...
                    if (self.configuration.enableRegistrationIcon) {
                        ...
                        self.registered.addClass("success").fadeIn(10).fadeOut(3e3);
                    }
                ...
                this.eventBus.on("connected", function(e) {
                    if (self.configuration.enableConnectionIcon) {
                        ...
                        self.connected.addClass("success").fadeIn(10).fadeOut(3e3);
                    }
                ...
                this.eventBus.on("incomingCall", function(evt) {
                    ...
                    WebRTC.Utils.rebindListeners("click", [ self.rejectIncomingCall, self.acceptIncomingCall, self.holdAndAnswerButton, self.dropAndAnswerButton ], function(e) {
                        e.preventDefault();
