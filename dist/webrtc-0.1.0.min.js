...
(function(window) {
    ...
    (function(WebRTC) {
        ...
        EventBus = function(options) {
            ...
            var events = [ "message", "userMediaUpdated", "reInvite", "incomingCall", "connected", "registered", "registrationFailed", "disconnected", "progress", "failed", "started", "held", "resumed", "ended", "calling", "newDTMF", "viewChanged", "dataSent", "dataReceived", "smsLoggedIn", "smsReadAll", "smsSent" ];
